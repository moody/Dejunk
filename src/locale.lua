...
L.CMD_HELP_DESTROY = "Destroy the next junk item."
L.CMD_HELP_LOOT = "Open lootable items."
L.CMD_HELP_SELL = "Start selling junk items."
L.CMD_HELP_TOGGLE = "Toggle the user interface."
L.COMMANDS = "Commands"
...
L.JUNK_FRAME_TOOLTIP = "Junk items you currently possess will be listed in this frame.|n|nDrop an item into the frame to add it to %s. Right-Click an item in the frame to add it to %s.|n|nTo add all items to %s, hold Ctrl + Alt and Right-Click this title."
