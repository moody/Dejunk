...
L["EXCLUDE_WARBOUND_EQUIPMENT_TEXT"] = "Exclude Warbound Equipment"
L["EXCLUDE_WARBOUND_EQUIPMENT_TOOLTIP"] = "Exclude equipment that can be placed in the warband bank."
L["EXCLUDE"] = "Exclude"
...
L["INCLUDE_BELOW_ITEM_LEVEL_TOOLTIP"] = "Include soulbound equipment with an item level below a set value (%s).|n|nDoes not apply to generic items, cosmetic items, or fishing poles."
