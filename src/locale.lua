...
L.INCLUDE_BELOW_AVERAGE_EQUIPMENT_TOOLTIP = "Include equipment with an item level slightly below your average equipped item level.|n|nOnly applies to soulbound items."
