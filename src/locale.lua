...
L["JUNK_FRAME_TOOLTIP"] = "Junk items you currently possess will be listed in this frame.|n|nTo add an item to %s, drop it into the frame below.|n|nTo add an item to %s, drop it into the frame below while holding Shift."
L["JUNK_ITEMS"] = "Junk Items"
L["KEYBINDS"] = "Keybinds"
L["LEFT_CLICK"] = "Left-Click"
L["LIST_FRAME_SWITCH_BUTTON_TEXT"] = "Switch View"
L["LIST_FRAME_SWITCH_BUTTON_TOOLTIP"] = "Switch the view between Global and Character lists."
