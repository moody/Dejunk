...
L.COMMAND_DESCRIPTION_LOOT = "Toggle the lootable items frame."
L.COMMAND_DESCRIPTION_OPTIONS = "Toggle the options frame."
L.COMMAND_DESCRIPTION_PROFILES = "Toggle the profiles frame."
L.COMMAND_DESCRIPTION_SELL = "Start selling junk items."
L.COMMANDS = "Commands"
L.COMMON = "Common"
L.CONTROL_KEY = "Ctrl"
L.DEFAULT_PROFILE_NAME = "Default"
L.DELETE_PROFILE_POPUP_HELP = "Delete %s? This cannot be undone."
L.DELETE = "Delete"
L.DESTROY_ITEM_POPUP_HELP = "Destroy %s?"
...
L.EPIC = "Epic"
L.EXCLUDE_ABOVE_ITEM_LEVEL_TEXT = "Exclude Above Item Level"
L.EXCLUDE_ABOVE_ITEM_LEVEL_TOOLTIP = "Exclude equipment with an item level above a set value (%s), even if it's on an Inclusions list."
...
L.EXCLUSIONS_DESCRIPTION_PROFILE = "Items on this list will never be considered junk."
L.EXCLUSIONS_TEXT = "Exclusions"
L.EXPORT = "Export"
L.FAILED_TO_DESTROY_ITEM = "Failed to destroy %s."
L.FAILED_TO_SELL_ITEM = "Failed to sell %s."
L.GLOBAL = "Global"
L.GLOBAL_OPTIONS_TOOLTIP = "These options apply to every character, regardless of active profile."
L.IGNORE = "Ignore"
L.IGNORE_LOOTABLE_ITEM_TOOLTIP = "Ignore all instances of this item for the rest of the session."
L.IMPORT = "Import"
...
L.INCLUSIONS_DESCRIPTION_GLOBAL = "Items on this list will be considered junk unless excluded by %s or %s."
L.INCLUSIONS_DESCRIPTION_PROFILE = "Items on this list will always be considered junk, unless excluded by %s."
...
L.ITEM_LEVEL_OPTION_POPUP_HELP = "Enter an item level:"
...
L.LOADING = "Loading"
L.LOOT = "Loot"
L.LOOTABLE_ITEMS = "Lootable Items"
...
L.NEW_PROFILE_POPUP_HELP = "Enter a profile name:"
...
L.POOR = "Poor"
L.PROFILE = "Profile"
L.PROFILE_OPTIONS_TOOLTIP = "These options only apply to characters using the active profile (%s)."
L.PROFILES = "Profiles"
L.PROFIT = "Profit: %s"
L.RARE = "Rare"
...
L.REMOVE = "Remove"
L.RENAME_PROFILE_POPUP_HELP = "Enter a new name for %s:"
L.RENAME = "Rename"
L.REPAIRED_ALL_ITEMS = "Repaired all items for %s."
L.RESET = "Reset"
L.RESET_POSITION = "Reset Position"
L.RESET_PROFILE_POPUP_HELP = "Reset %s to the default options? This cannot be undone."
L.RIGHT_CLICK = "Right-Click"
L.SAFE_DESTROY_TEXT = "Safe Destroy"
L.SAFE_DESTROY_TOOLTIP = "Require confirmation before destroying an item."
L.SAFE_SELL_TEXT = "Safe Sell"
L.SAFE_SELL_TOOLTIP = "Only sell up to 12 items at a time."
...
L.TOGGLE_LOOTABLE_FRAME = "Toggle Lootable Frame"
L.TOGGLE_OPTIONS_FRAME = "Toggle Options Frame"
L.TOGGLE_PROFILES_FRAME = "Toggle Profiles Frame"
