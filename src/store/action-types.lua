...
ActionTypes.Global = {
  ...
  SET_INCLUDE_BY_TSM_DISENCHANT = "global/includeByTsmDisenchant/set",
  PATCH_INCLUDE_BY_TSM_DISENCHANT = "global/includeByTsmDisenchant/patch",
...
ActionTypes.Perchar = {
  ...
  SET_INCLUDE_BY_TSM_DISENCHANT = "perchar/includeByTsmDisenchant/set",
  PATCH_INCLUDE_BY_TSM_DISENCHANT = "perchar/includeByTsmDisenchant/patch",
