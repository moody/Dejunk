...
EventManager:Once(E.SavedVariablesReady, function()
  local object = LDB:NewDataObject(ADDON_NAME, {
    ...
    OnTooltipShow = function(tooltip)
      ...
      tooltip:AddDoubleLine(Colors.Gold(L.LEFT_CLICK), Colors.White(L.TOGGLE_OPTIONS_FRAME))
      tooltip:AddDoubleLine(Colors.Gold(L.RIGHT_CLICK), Colors.White(L.TOGGLE_JUNK_FRAME))
      tooltip:AddDoubleLine(Colors.Gold(L.SHIFT_RIGHT_CLICK), Colors.White(L.DESTROY_NEXT_ITEM))
    end
  })
