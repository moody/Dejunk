...
_G.BINDING_NAME_DEJUNK_ADD_INCLUSIONS = L.BINDINGS_ADD_TO_LIST_TEXT:format(Lists.sell.inclusions.profile.locale)
_G.BINDING_NAME_DEJUNK_REM_INCLUSIONS = L.BINDINGS_REMOVE_FROM_LIST_TEXT:format(Lists.sell.inclusions.profile.locale)
_G.BINDING_NAME_DEJUNK_ADD_EXCLUSIONS = L.BINDINGS_ADD_TO_LIST_TEXT:format(Lists.sell.exclusions.profile.locale)
_G.BINDING_NAME_DEJUNK_REM_EXCLUSIONS = L.BINDINGS_REMOVE_FROM_LIST_TEXT:format(Lists.sell.exclusions.profile.locale)
_G.BINDING_NAME_DEJUNK_ADD_INCLUSIONS_GLOBAL = L.BINDINGS_ADD_TO_LIST_TEXT:format(Lists.sell.inclusions.global.locale)
_G.BINDING_NAME_DEJUNK_REM_INCLUSIONS_GLOBAL = L.BINDINGS_REMOVE_FROM_LIST_TEXT:format(Lists.sell.inclusions.global.locale)
_G.BINDING_NAME_DEJUNK_ADD_EXCLUSIONS_GLOBAL = L.BINDINGS_ADD_TO_LIST_TEXT:format(Lists.sell.exclusions.global.locale)
_G.BINDING_NAME_DEJUNK_REM_EXCLUSIONS_GLOBAL = L.BINDINGS_REMOVE_FROM_LIST_TEXT:format(Lists.sell.exclusions.global.locale)
...
_G.BINDING_NAME_DEJUNK_ADD_DESTROYABLES = L.BINDINGS_ADD_TO_LIST_TEXT:format(Lists.destroy.inclusions.profile.locale)
_G.BINDING_NAME_DEJUNK_REM_DESTROYABLES = L.BINDINGS_REMOVE_FROM_LIST_TEXT:format(Lists.destroy.inclusions.profile.locale)
_G.BINDING_NAME_DEJUNK_ADD_UNDESTROYABLES = L.BINDINGS_ADD_TO_LIST_TEXT:format(Lists.destroy.exclusions.profile.locale)
_G.BINDING_NAME_DEJUNK_REM_UNDESTROYABLES = L.BINDINGS_REMOVE_FROM_LIST_TEXT:format(Lists.destroy.exclusions.profile.locale)
_G.BINDING_NAME_DEJUNK_ADD_DESTROYABLES_GLOBAL = L.BINDINGS_ADD_TO_LIST_TEXT:format(Lists.destroy.inclusions.global.locale)
_G.BINDING_NAME_DEJUNK_REM_DESTROYABLES_GLOBAL = L.BINDINGS_REMOVE_FROM_LIST_TEXT:format(Lists.destroy.inclusions.global.locale)
_G.BINDING_NAME_DEJUNK_ADD_UNDESTROYABLES_GLOBAL = L.BINDINGS_ADD_TO_LIST_TEXT:format(Lists.destroy.exclusions.global.locale)
_G.BINDING_NAME_DEJUNK_REM_UNDESTROYABLES_GLOBAL = L.BINDINGS_REMOVE_FROM_LIST_TEXT:format(Lists.destroy.exclusions.global.locale)
