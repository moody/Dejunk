...
-- Upvalues
local strupper, max = strupper, max
...
function TitleFrame:OnInitialize()
  ...
  ui.TitleFontString:SetText(strupper(AddonName))
...
function TitleFrame:SetTitleToDejunk()
  ...
  self.UI.TitleFontString:SetText(strupper(AddonName))
...
function TitleFrame:SetTitleToDestroy()
  assert(self.Initialized)
  self.UI.TitleFontString:SetText(strupper(L.DESTROY_TEXT))
