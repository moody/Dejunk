...
L["AUTO_DESTROY_TOOLTIP"] = "Automatically begin destroying items when less than 5 empty bag slots remain."
...
L["POOR_TEXT"] = "Poor"
L["PRICE_THRESHOLD_TEXT"] = "Price Treshold"
L["PRICE_THRESHOLD_TOOLTIP"] = "Only destroy items or stacks of items worth less than a set price."
L["RARE_TEXT"] = "Rare"
