...
L["DESTROY_IGNORE_READABLE_TEXT"] = "Readable"
L["DESTROY_IGNORE_READABLE_TOOLTIP"] = "Ignore items that can be read."
...
L["REASON_DESTROY_IGNORE_READABLE_TEXT"] = "Readable items are ignored."
