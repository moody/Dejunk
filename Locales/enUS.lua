...
L["ITEM_TOOLTIP_TOOLTIP"] = "Display a Dejunk message in an item's tooltip indicating whether or not it will be sold. Hold <Shift> to display a Destroy message instead.|n|nHold <Alt> or <Shift+Alt> to display the reason.|n|nThis tooltip only applies when mousing over items in your bags."
...
L["REASON_DESTROY_TRESHOLD_MET_TEXT"] = "Price treshold of %s met."
L["REASON_DESTROY_TRESHOLD_NOT_MET_TEXT"] = "Price treshold of %s not met."
