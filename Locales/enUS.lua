...
L["ITEM_TOOLTIP_TOOLTIP"] = "Display a Dejunk message in an item's tooltip indicating whether or not it will be sold.|n|nHold <Alt> to display the reason.|n|nThis tooltip only applies when mousing over items in your bags."
