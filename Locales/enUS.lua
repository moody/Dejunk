...
L["DESTROYED_ONE_ITEM"] = "Destroyed 1 junk item worth %s."
L["DESTROYED_MULTIPLE_ITEMS"] = "Destroyed %s junk items worth %s in total."
...
L["IGNORE_ITEMS_MARKED_AS_TOOLTIP"] = "Ignore items marked as \"%s.\""
