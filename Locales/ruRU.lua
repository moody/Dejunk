...
L["COLOR_SCHEME_SET_TEXT"] = "Цвет изменен на %s."
...
L["SELL_EQUIPMENT_BELOW_ILVL_TOOLTIP"] = "Продавайте все предметы, имеющие определенный уровень предмета.|n|nВыбранные предметы обычного качества или выше с уровнем предмета, большим или равным указанному уровню предмета, будут проигнорированы.|n|nКосметические предметы и рыбные пиры не подвержены этой настройке."
