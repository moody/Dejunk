...
L["DESTROY_PETS_ALREADY_COLLECTED_TEXT"] = "Питомец уже собран"
L["DESTROY_PETS_ALREADY_COLLECTED_TOOLTIP"] = "Уничтожает питомцев если у вас есть в коллекции хотя бы один есть.|n|nТолько для питомцев, которые не могут быть проданы."
L["DESTROY_TEXT"] = "Уничтожить"
L["DESTROY_TOYS_ALREADY_COLLECTED_TEXT"] = "Игрушка уже собрана"
...
L["GENERAL_TEXT"] = "Общий"
L["IGNORE_BATTLEPETS_TEXT"] = "Боевой Питомец"
L["IGNORE_BATTLEPETS_TOOLTIP"] = "Игнорируйте боевых и обычных питомцев."
L["IGNORE_BOE_TEXT"] = "Персональный при надевании"
...
L["IGNORE_COSMETIC_TEXT"] = "Косметика"
...
L["IGNORE_EQUIPMENT_SETS_TEXT"] = "Комплект экипировки"
...
L["ITEM_CANNOT_BE_SOLD"] = "%s не может быть продана."
...
L["REASON_DESTROY_IGNORE_EXCLUSIONS_TEXT"] = "Предметы исключений игнорируются."
L["REASON_DESTROY_INCLUSIONS_TEXT"] = "Предметы по включениям уничтожаются."
