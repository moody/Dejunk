...
L["CLASS_TEXT"] = "Class"
L["CMD_HELP_DESTROY_ALL"] = "Destroys all items at once.|n|n|cFFE34F4FWARNING:|r This command is volatile, and you may experience frame-rate drops or disconnects when destroying items in large quantities."
